...
class ExportXLSXWizard(models.TransientModel):
    ...
    res_model = fields.Char(string='Resource Model', readonly=True, required=True, size=500)
    ...
    def action_export(self):
        ...
        out_file, out_name = Export.export_xlsx(self.template_id, self.res_model, safe_eval(self.res_ids))
        self.write({'state': 'get', 'data': out_file, 'name': out_name})
        return {
            'name': _('Output Results'),
